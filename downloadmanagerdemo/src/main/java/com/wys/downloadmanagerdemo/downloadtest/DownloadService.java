...
public class DownloadService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Notification mNotification = new NotificationBean(this, R.drawable.ic_launcher, "开始下载", System
                .currentTimeMillis());
            ...
            this.mListener = new IOnDownloadListener() {
                ...
                public void updateNotification(int progress, int totalSize, File downFile) {
                    ...
                    if (totalSize > 0) {
                        ...
                        mHandler.obtainMessage(DOWN_LOADING, rate, mDownTask.getNotifyID(), mDownTask
                                .getNotification()).sendToTarget();
                    } else if (totalSize == 0) {
