package com.meevii.customview.stepview;
...
public class FlowViewHorizontal extends View {
    ...
    public FlowViewHorizontal(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        bgRadius = ta.getDimension(R.styleable.FlowViewHorizontal_h_bg_radius, 10);//节点半径
        proRadius = ta.getDimension(R.styleable.FlowViewHorizontal_h_pro_radius, 8);//节点半径pro
